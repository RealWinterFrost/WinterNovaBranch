...
/datum/atmosphere/cold_breathable_planet
	id = SAFE_PLANET_COLD_ATMOS
	...
	minimum_temp = COLD_PLANET_TEMPERATURE - 5
	maximum_temp = COLD_PLANET_TEMPERATURE + 5
